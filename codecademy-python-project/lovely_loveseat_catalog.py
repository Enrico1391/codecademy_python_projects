# Variables for the first item itemization and price
...
# Variables for the second item itemization and price
...
# Variables for the third item itemization and price
...
# Variables for the first customer expenses
